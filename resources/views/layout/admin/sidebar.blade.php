...
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #320A6B;">
    ...
    <a href="{{ route('dashboard') }}" class="brand-link" style="background-color: #065084;">
        ...
        <span class="brand-text font-weight-bold text-white">Kenzo Laundy</span>
    </a>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column text-lg" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="{{ route('pembayaran') }}"
                       class="nav-link {{ request()->routeIs('pembayaran') ? 'active-custom' : '' }}">
                        <i class="nav-icon fas fa-money-check-alt fa-lg"></i>
                        <p>Pembayaran</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('kurir') }}"
                       class="nav-link {{ request()->routeIs('kurir') ? 'active-custom' : '' }}">
                        <i class="nav-icon fas fa-motorcycle fa-lg"></i>
                        <p>Kurir</p>
                    </a>
                </li>
