    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column text-lg" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ route('dashboard') }}" class="nav-link {{ request()->routeIs('dashboard') ? 'active-custom' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('layanan') }}" class="nav-link {{ request()->routeIs('layanan') ? 'active-custom' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('order') }}" class="nav-link {{ request()->routeIs('order') ? 'active-custom' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('laporan') }}" class="nav-link {{ request()->routeIs('laporan') ? 'active-custom' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('pembayaran') }}" class="nav-link {{ request()->routeIs('pembayaran') ? 'active-custom' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('pelanggan') }}" class="nav-link {{ request()->routeIs('pelanggan') ? 'active-custom' : '' }}">
